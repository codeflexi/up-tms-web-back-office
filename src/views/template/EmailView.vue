<template>
  <div id="EmailView" class="bg-gray-50 h-screen font-display">
    ...
    <div class="flex w-full">
      <div  v-if="globalStore.getIsNavbar"  id="SideMenu" 
   ...
   <!-- v-if="isNavbar"  -->
        ...
        @click="newMessageOpen = true"
          class="
            ...
            cursor-pointer
            text-white
            uppercase  racking-wider font-semibold text-sm
            px-5 py-3  shadow-lg
            hover:bg-red-500
          "
        >
        ...
        <router-link to="/pickup" active-class="active">
          <div
            class="
              flex
              side-menu-item
          ...
          >
              ...
              <div class="flex items-center">
                ...
                <div class="text-sm pl-4 font-semibold">Pickup</div>
              </div>
        ...
        <div class="flex side-menu-item justify-between px-6 py-1.5  hover:bg-red-500 hover:rounded-r-full active:bg-red-700">
          <div class="flex items-center">
