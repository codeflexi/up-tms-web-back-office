  ...
  <div id="EmailView" class="bg-gray-50 h-screen">
    <div id="TopMenu" class="flex items-center p-2">
      <div class="logo-section flex justify-start items-center px-3.5">
        ...
        <img width="107" src="../../../public/img/up_logo.png" alt=""  class="logo-size"/>
      </div>
    ...
    <div class="flex w-full">
      <div id="SideMenu" class="side-menu">
        ...
        <div class="flex side-menu-item justify-between px-6 py-1.5  hover:bg-red-500 hover:rounded-r-full">
          <div class="flex items-center">
